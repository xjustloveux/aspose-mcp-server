...
public static class ExcelNamedRangeHelper
{
    ...
    public static Range ParseRangeWithSheetReference(Workbook workbook, string rangeAddress)
    {
    ...
    /// <returns>The Range object corresponding to the address.</returns>
    public static Range CreateRangeFromAddress(Cells cells, string address)
    {
