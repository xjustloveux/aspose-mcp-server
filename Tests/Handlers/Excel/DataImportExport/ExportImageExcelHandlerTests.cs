...
public class ExportImageExcelHandlerTests : ExcelHandlerTestBase
{
    private readonly ExportImageExcelHandler _handler = new();
    ...
    {
        Assert.Equal("export_image", _handler.Operation);
    }
    ...
    {
        var result = ExportImageExcelHandler.ResolveImageType(format);
    ...
    public void ResolveImageType_WithInvalidFormat_ShouldThrow()
    {
        var ex = Assert.Throws<ArgumentException>(() =>
            ExportImageExcelHandler.ResolveImageType("invalid"));
