...
public class DeleteExcelPivotTableHandlerTests : ExcelHandlerTestBase
{
    private readonly DeleteExcelPivotTableHandler _handler = new();
    ...
    [Fact]
    public void Execute_DeletesPivotTable()
    {
