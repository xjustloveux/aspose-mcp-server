...
public class SetSheetPropertiesHandlerTests : ExcelHandlerTestBase
{
    private readonly SetSheetPropertiesHandler _handler = new();
    ...
    {
        Assert.Equal("set_sheet", _handler.Operation);
    }
