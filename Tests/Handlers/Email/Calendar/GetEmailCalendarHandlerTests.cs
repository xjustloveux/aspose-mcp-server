...
/// <summary>
///     Tests for <see cref="GetEmailCalendarHandler" />.
/// </summary>
public class GetEmailCalendarHandlerTests : HandlerTestBase<object>
{
    private readonly GetEmailCalendarHandler _handler = new();
