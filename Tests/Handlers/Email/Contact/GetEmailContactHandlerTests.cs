...
/// <summary>
///     Tests for <see cref="GetEmailContactHandler" />.
/// </summary>
public class GetEmailContactHandlerTests : HandlerTestBase<object>
{
    private readonly GetEmailContactHandler _handler = new();
