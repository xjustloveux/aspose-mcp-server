...
public class ListWordFootnotesHandlerTests : WordHandlerTestBase
{
    private readonly ListWordFootnotesHandler _handler = new();
    ...
    {
        Assert.Equal("list_footnotes", _handler.Operation);
    }
