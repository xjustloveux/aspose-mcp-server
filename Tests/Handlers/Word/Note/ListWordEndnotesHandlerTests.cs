...
public class ListWordEndnotesHandlerTests : WordHandlerTestBase
{
    private readonly ListWordEndnotesHandler _handler = new();
    ...
    {
        Assert.Equal("list_endnotes", _handler.Operation);
    }
