...
public class ListFormFieldsWordHandlerTests : WordHandlerTestBase
{
    private readonly ListFormFieldsWordHandler _handler = new();
    ...
    {
        Assert.Equal("list_forms", _handler.Operation);
    }
