...
public class ListTextboxesWordHandlerTests : WordHandlerTestBase
{
    private readonly ListTextboxesWordHandler _handler = new();
    ...
    {
        Assert.Equal("list_textboxes", _handler.Operation);
    }
