...
public class ExcelRenderToolTests : ExcelTestBase
{
    ...
    public void RenderSheet_ShouldRenderToImage()
    {
        ...
        var result = _tool.Execute("render", workbookPath, outputPath: outputPath);
    ...
    public void RenderSheet_WithJpegFormat_ShouldRenderToJpeg()
    {
        ...
        var result = _tool.Execute("render", workbookPath, outputPath: outputPath, format: "jpeg");
        var data = GetResultData<RenderExcelResult>(result);
        Assert.Contains("render", data.Message, StringComparison.OrdinalIgnoreCase);
    ...
    public void RenderSheet_WithCustomDpi_ShouldRender()
    {
        ...
        var result = _tool.Execute("render", workbookPath, outputPath: outputPath, dpi: 300);
        var data = GetResultData<RenderExcelResult>(result);
        Assert.Contains("render", data.Message, StringComparison.OrdinalIgnoreCase);
        Assert.True(File.Exists(data.OutputPaths[0]));
    }
    ...
    public void Execute_WithNoPathOrSessionId_ShouldThrowException()
    {
        ...
        Assert.ThrowsAny<Exception>(() => _tool.Execute("render", outputPath: outputPath));
    }
    ...
    public void RenderSheet_WithSession_ShouldRenderFromMemory()
    {
        ...
        var result = _tool.Execute("render", sessionId: sessionId, outputPath: outputPath);
        var data = GetResultData<RenderExcelResult>(result);
        Assert.Contains("render", data.Message, StringComparison.OrdinalIgnoreCase);
        Assert.True(data.OutputPaths.Count >= 1);
        Assert.True(File.Exists(data.OutputPaths[0]));
    ...
    public void Execute_WithInvalidSessionId_ShouldThrowKeyNotFoundException()
    {
        ...
        Assert.Throws<KeyNotFoundException>(() =>
            _tool.Execute("render", sessionId: "invalid_session", outputPath: outputPath));
    }
    ...
    public void Execute_WithBothPathAndSessionId_ShouldPreferSessionId()
    {
        ...
        var result = _tool.Execute("render", pathWorkbook, sessionId, outputPath);
        var data = GetResultData<RenderExcelResult>(result);
        Assert.True(data.OutputPaths.Count >= 1);
        Assert.True(File.Exists(data.OutputPaths[0]));
    }
