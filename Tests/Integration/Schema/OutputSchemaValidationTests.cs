...
public class OutputSchemaValidationTests
{
    ...
    /// <summary>
    ///     Validates schema structure has required data and output fields at the top level.
    ///     Both namespace-generated and type-generated schemas emit the FinalizedResult
    ///     shape directly (no wrapper layer), so the same assertions apply to both.
    /// </summary>
