...
$scannerArgs = @(
    ...
    "/d:sonar.exclusions=**/deploy/web.config,**/deploy/deployment.yaml,**/*.lic,**/*.ps1,**/graphify-out/**,**/graphify/**,**/coverage-reports/**,**/sonar-reports/**,**/docs/architecture-map/**,**/docs/assets/**",
    "/d:sonar.cpd.exclusions=**/Results/**",
    "/d:sonar.issue.ignore.multicriteria=e1,e2,e3,e4,e5,e6,e7,e8,e9,e10,e11,e12,e13,e14,e16,e17,e18,e19,e20,e21,e22,e23,e24,e25,e26,e27,e28,e29,e30,e31,e32,e33,e34,e35,e36",
