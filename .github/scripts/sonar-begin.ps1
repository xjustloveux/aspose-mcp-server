...
$scannerArgs = @(
    ...
    "/d:sonar.exclusions=**/deploy/web.config,**/deploy/deployment.yaml,**/*.ps1,**/graphify-out/**,**/graphify/**,**/coverage-reports/**,**/sonar-reports/**,**/docs/architecture-map/**,**/docs/assets/**",
