...
public class PptAddAudioTool : IAsposeTool
{
    public string Description => "Insert an embedded audio frame into a slide";
    ...
    public object InputSchema => new
    {
        ...
        properties = new
        {
            ...
            {
                type = "number",
                description = "Width (optional, default: 80)"
            },
            height = new
            {
                type = "number",
                description = "Height (optional, default: 80)"
            }
        },
        required = new[] { "path", "slideIndex", "audioPath" }
    };
    ...
    public async Task<string> ExecuteAsync(JsonObject? arguments)
    {
        ...
        var audioPath = arguments?["audioPath"]?.GetValue<string>() ?? throw new ArgumentException("audioPath is required");
