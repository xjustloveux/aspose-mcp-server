...
public class PptDeleteVideoTool : IAsposeTool
{
    public string Description => "Delete a video frame from a PowerPoint slide";
    ...
    public object InputSchema => new
    {
        ...
        properties = new
        {
            ...
            {
                type = "number",
                description = "Shape index of the video (0-based)"
            }
        },
