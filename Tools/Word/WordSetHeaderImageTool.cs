...
public class WordSetHeaderImageTool : IAsposeTool
{
    public string Description => "Set image for header in a Word document (fine-grained control)";
    ...
    public object InputSchema => new
    {
        ...
        properties = new
        {
            ...
            {
                type = "number",
                description = "Image width in points (default: 50)"
            },
            height = new
            {
                type = "number",
    ...
    public async Task<string> ExecuteAsync(JsonObject? arguments)
    {
        ...
        foreach (Section section in sections)
        {
            ...
            imageShape.Width = width.HasValue ? width.Value : 50.0;
            if (height.HasValue)
        ...
        return await Task.FromResult($"成功設定頁首圖片於 {sectionsDesc}");
    }
