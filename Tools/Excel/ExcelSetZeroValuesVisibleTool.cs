...
public class ExcelSetZeroValuesVisibleTool : IAsposeTool
{
    public string Description => "Set zero values visibility in Excel worksheet";
    ...
    public object InputSchema => new
    {
        ...
        properties = new
        {
            ...
            {
                type = "boolean",
                description = "Zero values visibility (true = visible, false = hidden)"
            }
        },
