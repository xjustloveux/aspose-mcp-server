...
public class ExcelSetGridlinesVisibleTool : IAsposeTool
{
    public string Description => "Set gridlines visibility in Excel worksheet";
    ...
    public object InputSchema => new
    {
        ...
        properties = new
        {
            ...
            {
                type = "boolean",
                description = "Gridlines visibility (true = visible, false = hidden)"
            }
        },
