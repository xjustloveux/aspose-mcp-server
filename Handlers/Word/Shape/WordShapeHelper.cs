...
public static class WordShapeHelper
{
    ...
    public static List<Aspose.Words.Drawing.Shape> FindAllTextboxes(Document doc)
    {
        List<Aspose.Words.Drawing.Shape> textboxes = [];
        foreach (var section in doc.Sections.Cast<Section>())
        {
            // Search in main body
            var bodyShapes = section.Body.GetChildNodes(NodeType.Shape, true).Cast<Aspose.Words.Drawing.Shape>()
            ...
            {
                var headerShapes = header.GetChildNodes(NodeType.Shape, true).Cast<Aspose.Words.Drawing.Shape>()
                    .Where(s => s.ShapeType == ShapeType.TextBox);
    ...
    public static List<Aspose.Words.Drawing.Shape> GetAllShapes(Document doc)
    {
        return doc.GetChildNodes(NodeType.Shape, true).Cast<Aspose.Words.Drawing.Shape>().ToList();
    }
