...
public static class WordTableHelper
{
    ...
    public static List<Aspose.Words.Tables.Table> GetTables(Document doc, int? sectionIndex)
    {
        if (sectionIndex.HasValue)
        {
            ...
            return section.Body.GetChildNodes(NodeType.Table, true).Cast<Aspose.Words.Tables.Table>().ToList();
        }
    ...
    public static Aspose.Words.Tables.Table GetTable(Document doc, int tableIndex, int? sectionIndex)
    {
    ...
    public static string GetPrecedingText(Aspose.Words.Tables.Table table, int maxLength)
    {
