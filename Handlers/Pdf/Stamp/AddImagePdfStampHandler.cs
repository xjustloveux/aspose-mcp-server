...
/// <summary>
///     Handler for adding image stamps to PDF documents.
/// </summary>
[ResultType(typeof(SuccessResult))]
public class AddImagePdfStampHandler : OperationHandlerBase<Document>
{
    /// <inheritdoc />
    public override string Operation => "add_image";

    /// <summary>
    ///     Adds an image stamp to one or all pages in the PDF document.
    /// </summary>
    /// <param name="context">The document context.</param>
    /// <param name="parameters">
    ///     Required: imagePath.
    ///     Optional: pageIndex (default: 0, 0 = all pages), x, y, width, height, opacity, rotation.
    /// </param>
    ...
    /// <summary>
    ///     Extracts parameters for the add image stamp operation.
    /// </summary>
    /// <param name="parameters">The operation parameters.</param>
    /// <returns>The extracted parameters.</returns>
    private static AddImageStampParameters ExtractParameters(OperationParameters parameters)
    {
        return new AddImageStampParameters(
    ...
    /// <summary>
    ///     Parameters for the add image stamp operation.
    /// </summary>
    ...
    private sealed record AddImageStampParameters(
        string ImagePath,
        int PageIndex,
        double X,
        double Y,
