...
public static class ExcelPivotTableHelper
{
    ...
    public static List<string> GetAvailableFieldNames(Worksheet sourceSheet, Aspose.Cells.Range sourceRangeObj)
    {
    ...
    public static (Worksheet sourceSheet, Aspose.Cells.Range sourceRangeObj) ParseDataSource(
        Workbook workbook,
