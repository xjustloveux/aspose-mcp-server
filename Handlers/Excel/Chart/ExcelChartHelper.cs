...
public static class ExcelChartHelper
{
    ...
    public static void SetCategoryData(Aspose.Cells.Charts.Chart chart, string categoryAxisDataRange)
    {
    ...
    public static void AddDataSeries(Aspose.Cells.Charts.Chart chart, string dataRange)
    {
        chart.NSeries.Clear();
    ...
    public static Aspose.Cells.Charts.Chart GetChart(Worksheet worksheet, int chartIndex)
    {
