...
public record OcrRecognitionResult
{
    ...
    /// <summary>
    ///     Overall recognition confidence score. The bundled Aspose.OCR engine does not report
    ///     confidence values, so this is always 0; it is kept for wire-format stability.
    /// </summary>
